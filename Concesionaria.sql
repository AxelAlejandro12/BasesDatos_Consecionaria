...
REFERENCES Relaciones.Realiza (id_Servicios, numEmpleado);
...
--tabla realiza
ALTER TABLE Relaciones.Realiza (
    id_Servicio CHAR(8) NOT NULL,
    numEmpleado CHAR(18) NOT NULL,
    fecha DATE NOT NULL,
	costo DECIMAL(10,2) NOT NULL,
...
ALTER TABLE Relaciones.Realiza
DROP CONSTRAINT FK_Realiza_Reparacion;

ALTER TABLE Relaciones.Realiza
DROP CONSTRAINT FK_Realiza_Mecanico;

ALTER TABLE Operaciones.Coche
DROP CONSTRAINT FK_Coche_Realiza;

ALTER TABLE Relaciones.Realiza
ADD CONSTRAINT PK_Realiza PRIMARY KEY (id_Servicios, numEmpleado);

ALTER TABLE Relaciones.Realiza
ADD CONSTRAINT FK_Realiza_Reparacion FOREIGN KEY (id_Servicios) REFERENCES Operaciones.Reparacion(id_Reparacion);

ALTER TABLE Relaciones.Realiza
ADD CONSTRAINT FK_Realiza_Mecanico FOREIGN KEY (numEmpleado) REFERENCES Operaciones.Mecanico(id_Mecanico);
...
ALTER TABLE Relaciones.Realiza
DROP CONSTRAINT PK_Realiza_2DB9D4BAA8020D74;
...
INSERT INTO Operaciones.Aval (id_Aval, nombreAvalPila, apellidoPaternoAval, apellidoMaternoAval, estado, numero, calle, colonia, CURP, telefono, email, municipio, id_municipio, id_Estado, RFC_Clientes)
VALUES 
...
VALUES
('AUTO0001', 'Toyota', 'Corolla', 'ABC123DEF', 'PRO001', 'SERV0001', 'MEC0001', 'SERV0006', 'EMP028'),
('AUTO0002', 'Honda', 'Civic', 'BCD234EFG', 'PRO002', 'SERV0002', 'MEC0002', 'SERV0006', 'EMP030'),
('AUTO0003', 'Ford', 'Focus', 'CDE345FGH', 'PRO003', 'SERV0003', 'MEC0003', 'SERV0009', 'EMP029'),
('AUTO0004', 'Mazda', 'Sedan', 'DEF456GHI', 'PRO004', 'SERV0004', 'MEC0004', 'SERV0006', 'EMP028'),
('AUTO0005', 'Nissan', 'Altima', 'EFG567HIJ', 'PRO005', 'SERV0003', 'MEC0003', 'SERV0010', 'EMP031'),
('AUTO0006', 'Chevrolet', 'Malibu', 'FGH678IJK', 'PRO006', 'SERV0006', 'MEC0005', 'SERV0001', 'EMP003'),
('AUTO0007', 'Volkswagen', 'Jetta', 'GHI789JKL', 'PRO007', 'SERV0001', 'MEC0001', 'SERV0006', 'EMP030'),
('AUTO0008', 'Hyundai', 'Elantra', 'HIJ890KLM', 'PRO008', 'SERV0009', 'MEC0007', 'SERV0009', 'EMP029'),
('AUTO0009', 'Kia', 'Optima', 'IJK901LMN', 'PRO001', 'SERV0009', 'MEC0007', 'SERV0009', 'EMP029'),
('AUTO0010', 'Subaru', 'Impreza', 'JKL012MNO', 'PRO005', 'SERV0010', 'MEC0008', 'SERV0010', 'EMP031');


SELECT * 
FROM Relaciones.Realiza
WHERE id_servicios IN ('SERV0001', 'SERV0002', 'SERV0003', 'SERV0004', 'SERV0006', 'SERV0009', 'SERV0010')
  AND numempleado IN ('EMP003', 'EMP026', 'EMP027', 'EMP004', 'EMP028', 'EMP029', 'EMP031');
...
drop constraint FK_COCHE-- FOREIGN KEY (id_coche) REFERENCES Operaciones.Coche (id_coche)
ALTER TABLE Catalogos.Servicio
...
----------falta2
INSERT INTO Relaciones.Realiza (id_Servicios, numEmpleado, fecha, costo)
VALUES 
('SERV0001', 'MEC0001', '2024-11-10', 2500.00),
...
('SERV0008', 'MEC0006', '2024-11-15', 2200.00),
('SERV0009', 'MEC0007', '2024-11-16', 2700.00),
('SERV0010', 'MEC0008', '2024-11-17', 1800.00);

SELECT *
FROM Operaciones.Mecanico;

SELECT * FROM Operaciones.Reparacion
WHERE id_Servicio IN ('SERV0001', 'SERV0002', 'SERV0003', 'SERV0004', 'SERV0006', 'SERV0008', 'SERV0009', 'SERV0010');
...
ALTER TABLE Relaciones.Realiza
ADD CONSTRAINT FK_Realiza_Servicio FOREIGN KEY (id_Servicios) REFERENCES Catalogos.Servicio(id_Servicio);


INSERT INTO Relaciones.Tiene(id_Servicio, numEmpleado, fecha, costo, id_Revisiones, id_tecnicos)
VALUES 
...
add id_Revisiones CHAR (8) NOT NULL
alter table Relaciones.Tiene
add CONSTRAINT FK_Revision FOREIGN KEY (id_Revisiones) REFERENCES Operaciones.Revision (id_Revision)

alter table Relaciones.Tiene
add id_tecnicos CHAR (18) NOT NULL
alter table Relaciones.Tiene
add CONSTRAINT FK_Tecnico FOREIGN KEY (id_tecnicos) REFERENCES Operaciones.Tecnico (id_tecnico)
--comprobando los inserts 
